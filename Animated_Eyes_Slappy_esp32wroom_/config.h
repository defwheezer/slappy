...
#define TFT1_CS 2         // TFT 1 chip select pin (set to -1 to use TFT_eSPI setup)
...
#define DISPLAY_BACKLIGHT  4 // Pin for backlight control (-1 for none)
#define BACKLIGHT_MAX    255
#define TALKING_PIN 12 //pin high when Pi is talking or playing sound
#define AWAKE_PIN 14 //pin high when Pi is talking or playing sound
